...
ALTER TABLE lesson ADD skilllevel_id INT;
ALTER TABLE lesson ADD CONSTRAINT FK_lesson_0 FOREIGN KEY (skilllevel_id) REFERENCES skilllevel_and_price (skilllevel_id);
